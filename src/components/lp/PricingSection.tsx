...
export function PricingSection() {
  ...
  return (
    <div className="mx-auto max-w-[1000px] px-5 py-10 text-center text-brand-black sm:py-12">
      <span className="mb-4 inline-block rounded-full bg-[#fdeee3] px-4 py-1.5 text-[13px] font-bold text-[#c2530a]">
        Limited-Time Price
      </span>
      <h2 className="text-[26px] font-extrabold leading-tight sm:text-[38px]">
      ...
      <div className="mx-auto mt-7 max-w-[480px] rounded-2xl border border-brand-line bg-white p-8 shadow-sm">
