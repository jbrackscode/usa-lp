...
type FeatureRowProps = {
  ...
  // video instead of the static image, same frame/crop. A plain loading
  // area (no still image) shows until the video actually reports it can
  // play, then cross-fades in — so there's never a blank/empty tile while
  // the video downloads.
  video?: string;
  title: string;
  body: string;
